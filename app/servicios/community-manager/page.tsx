export default function CommunityManagerPage() {
  return (
    <section style={{ minHeight: '100vh', background: '#0B0F1A', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '120px 5%', textAlign: 'center' }}>
